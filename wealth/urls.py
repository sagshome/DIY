...
urlpatterns = [
    ...
    path(r'api/zero_wealth_summary', charts.zero_acc_summary, name='zero_wealth_summary'),
    ...
    path(r'account/<pk>/table/', views.AccountReconcileView.as_view(), name='account_table'),
    # path(r'account/<pk>/<date_str>/reconcile/', views.reconciliation, name='reconciliation'),
    path(r'account/<pk>/<date_str>/reconcile/', views.AccountDateReconcileView.as_view(), name='reconciliation'),
    ...
    path(r'transaction/<account_id>/withdraw/', views.set_transaction,  {'action': 'REDEEM'}, name='set_withdraw'),
    ...
    path(r'transaction/<pk>/<rec_type>/edit/', views.edit_transaction2, name='transaction_edit'),
