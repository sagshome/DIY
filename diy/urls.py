...
from base.views import diy_main, diy_check, NewAccountConfirmView, NewAccountDoneView


urlpatterns = [
    path("", diy_main, name='home_page'),
    path("health_check/", diy_check, name='health_check'),
    ...
    re_path("wealth/", include('wealth.urls')),
]
